...
function getDeepSeekResponse(viewProvider, prompt, onProgress) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (provider !== 'ollama' && !apiKey) {
            vscode.window.showErrorMessage((0, localize_1.localize)('error.apiKeyRequired', 'Please set the API key for {0}.', provider));
            return;
        }
        console.log('DeepSeek 请求开始');
                    ...
                    for (const line of lines) {
                        if (line.includes('error')) {
                            try {
                                ...
                                const errorMessage = ((_b = jsonData.error) === null || _b === void 0 ? void 0 : _b.message) || (0, localize_1.localize)('error.unknown', 'Unknown error');
                                ...
                                fullResponse += `\n\n${(0, localize_1.localize)('response.parseError', 'Request error: failed to parse response')}`;
                            }
                            break;
                        }
                ...
                while (true) {
                    ...
                    for (const line of lines) {
                        ...
                        if (line.includes('error') || line.includes('50501')) {
                            try {
                                const jsonData = JSON.parse(line);
                                const requestErrorMessage = ((_d = jsonData.error) === null || _d === void 0 ? void 0 : _d.message) || jsonData.message || JSON.stringify(jsonData);
    ...
    vscode.workspace.onDidChangeConfiguration((event) => {
        if (event.affectsConfiguration('deepseek.apiKey')) {
            ...
            if (apiKey) {
                ...
                vscode.window.showInformationMessage((0, localize_1.localize)('info.apiKeyUpdated', '{0} API key updated!', apiKeyType));
            }
        }
    });
